...
function DashboardSection({ selectedIncident, incidentData, onClose }: DashboardSectionProps) {
  return (
    <div className='w-4/5 p-4 bg-pink-100 border-3 border-pink-700 shadow-lg h-280 mx-2 overflow-y-auto'>
      {selectedIncident ? (
        (() => {
        ...
        <div className='flex items-center justify-center h-full'>
          <p className='text-gray-500 text-xl'>Select an incident or query to view details</p>
        </div>
      )}
    </div>
  );
